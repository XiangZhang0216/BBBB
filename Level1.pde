...
void level1()
{
  ...
  Level1Music=minim.loadFile("A Little Story.mp3");//The audio file is loaded again here to fix a bug that prevents the audio from playing if the level is played again after a win screen or death screen.
  Level1Music.play();
  Level1Music.loop();
  background(0);
  PImage img002;
